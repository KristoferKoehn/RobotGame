...
public partial class PlayerController : AbstractController
{
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        if (Model.GetType() == typeof(PlayerModel))
        {
            ((PlayerModel)Model).MovementBlendPosition = new Vector2(locomotionBlendPositionVector.X, -locomotionBlendPositionVector.Y);
        }
